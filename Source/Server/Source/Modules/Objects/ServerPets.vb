...
#Region "Data Functions"
    ...
    Public Function GetPetStat(ByVal Index As Integer, ByVal Stat As StatType) As Integer
        GetPetStat = 0
    ...
    Public Sub SetPetStat(ByVal Index As Integer, ByVal Stat As StatType, ByVal Amount As Integer)

...
#Region "Data"
    ...
    Public Sub PlayerCastSkill(ByVal skillslot As Integer)
        ...
        If PlayerSkills(skillslot) > 0 Then
            If GetTimeMs() > Player(MyIndex).AttackTimer + 1000 Then
...
#Region "Combat"
    Sub CheckAttack()
        ...
        If VbKeyControl Then
            ...
            If Player(MyIndex).AttackTimer + attackspeed < GetTimeMs() Then
                If Player(MyIndex).Attacking = 0 Then

                    With Player(MyIndex)
                        .Attacking = 1
                        .AttackTimer = GetTimeMs()
                    End With
            ...
            If GetTimeMs() > Player(MyIndex).EventTimer Then
                For i = 1 To Map.CurrentEvents
                    If Map.MapEvents(i).Visible = 1 Then
                        If Map.MapEvents(i).X = X And Map.MapEvents(i).Y = Y Then
                            ...
                            SendData(Buffer.ToArray)
                            Buffer = Nothing
                            Player(MyIndex).EventTimer = GetTimeMs() + 200
                        End If
                    End If
                Next
            End If
...
#Region "Incoming Packets"
    Sub Packet_PlayerInv(data() As Byte)
    ...
    Sub Packet_PlayerInvUpdate(data() As Byte)
    ...
    Sub Packet_PlayerWornEquipment(data() As Byte)
    ...
    Sub Packet_PlayerHP(data() As Byte)
        Dim Buffer As New ByteBuffer
    ...
    Sub Packet_PlayerMP(data() As Byte)
        Dim Buffer As New ByteBuffer
    ...
    Sub Packet_PlayerSP(data() As Byte)
        Dim Buffer As New ByteBuffer
        Buffer.WriteBytes(data)
    ...
    Sub Packet_PlayerStats(data() As Byte)
    ...
    Sub Packet_PlayerData(Data() As Byte)
    ...
    Sub Packet_PlayerMove(Data() As Byte)
    ...
    Sub Packet_PlayerDir(Data() As Byte)
    ...
    Sub Packet_PlayerXY(Data() As Byte)
    ...
    Sub Packet_Attack(Data() As Byte)
        Dim i As Integer
        Dim Buffer As New ByteBuffer
        ...
        Player(i).AttackTimer = GetTimeMs()

        Buffer = Nothing
    End Sub

    Sub Packet_PlayerExp(Data() As Byte)
    ...
    Sub Packet_Stunned(Data() As Byte)
        Dim Buffer As New ByteBuffer
    ...
    Sub Packet_MapWornEquipment(Data() As Byte)
    ...
    Sub Packet_Target(Data() As Byte)
        Dim Buffer As New ByteBuffer
